...
<section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] mt-8">
  <div class="container mx-auto">
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 mx-4 max-w-[570px] lg:mb-0">
          <h2
            class="text-dark mb-6 text-[32px] font-bold  sm:text-[40px] lg:text-[36px] xl:text-[40px]"
          >
            ¡Contáctanos!
          </h2>
          <p class="text-body-color mb-9 text-xl leading-relaxed">
            ¿Tienes alguna inquietud, duda o problema? Contáctanos y te echaremos una mano lo más pronto posible.
          </p>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-xl font-bold">Número de contacto</h4>
              <p class="text-body-color text-base">(+57) 320 455 2297</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">grupoeditorialshalom@gmail.com</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              <h4 class="text-dark text-xl font-bold">Nuestra ubicación</h4>
              <p class="text-body-color text-base">
                Diagonal 52C Bis N 25-39 Sur. Bogotá, Colombia.
              </p>
            </div>
          </div>
          <BaseDivider style="border-color: gray;"></BaseDivider>
          <iframe class="w-full" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3977.083241677965!2d-74.13569!3d4.579072!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9f2ff7b49085%3A0x2246fb03655cc85d!2sDg.%2052C%20Bis%20Sur%20%2325-39%2C%20Bogot%C3%A1!5e0!3m2!1ses!2sco!4v1677472253345!5m2!1ses!2sco"  style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      ...
      <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div class="relative mx-4 rounded-lg bg-cyan-500 p-8 shadow-lg sm:p-12">
            <h1 class="text-white mb-1 text-2xl font-bold">Formulario de contacto</h1><br/>
            <form>
            <div class="mb-6 ">
              <input
                type="text"
            ...
            <div class="mb-6">
              <input
                type="email"
                placeholder="Correo"
                class="placeholder-gray-500  border-white focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
              />
            </div>
            <div class="mb-6">
              <input
            ...
            <div class="mb-6">
              <textarea
                rows="6"
                placeholder="Mensaje"
                class="placeholder-gray-500  border-white focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
              ></textarea>
            </div>
            <div>
              <button
                type="submit"
                class="bg-primary  w-full rounded border p-3 text-black bg-cyan-100 font-bold transition hover:bg-opacity-90"
              >
                Enviar 
              </button>
            </div>
