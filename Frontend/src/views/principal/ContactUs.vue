...
<template>
  <div class="mx-auto">
    ...
    <section class="relative z-10 overflow-hidden py-20 lg:py-[120px] mt-8">
          ...
          <div class="w-full px-4 xl:w-6/12">
            ...
            >
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                <div
                  class="bg-primary mx-6 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                >
                  <svg
                    width="24"
                    height="26"
              ...
              <div class="mb-8 mx-6 flex w-full max-w-[370px]">
                <div
              ...
              <div class="mx-6 flex w-full max-w-[370px]">
                <div
                  class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                >
                  <svg
