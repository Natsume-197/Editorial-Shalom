<template>
  <div
    ...
    <div class="w-full sm:max-w-md p-5 mx-auto">
      <h2 class="mb-12 text-center text-5xl font-extrabold">Inicio de Sesión</h2>
      <form @submit.prevent="submit">
        ...
        <div class="mt-6 flex items-center justify-between">
          ...
          <router-link to="/" class="text-sm hover:underline"> ¿Has olvidado tu contraseña? </router-link>
        </div>
        <div class="mt-6">
          <button
