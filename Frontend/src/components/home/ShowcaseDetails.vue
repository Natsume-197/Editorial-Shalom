...
<template>
  <div class="w-full px-4 md:px-32 mx-auto bg-sky-200 pt-6">
    <div class="tabs text-left">
      <TabGroup>
        <TabList class="space-x-10 ">
          <Tab
          ...
          >
            <button
              :class="[
                ...
                'text-lg font-semibold text-white md:text-xl ',
                selected
                  ? 'text-lg font-semibold text-white-300 cursor-default outline-none text-center items-center rounded-xl  text-yellow-300'
        ...
        <h1 class="text-2xl font-semibold text-black mb-10 lg:text-3xl  dark:text-white">
            Te podrían interesar los siguientes libros...
        </h1>
