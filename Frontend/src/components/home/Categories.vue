        ...
        <div class="links__list py-2">
          ...
          <div class="links__item" style="height: 120px">
            ...
            >
              ...
              >
                <g transform="translate(-733.746 -567.746)">
                  <g
                    transform="translate(733.746 592.073) rotate(-20) scale(0.14)"
                  >
                    <path
                      fill="#f863a3"
                      d="M445.5,0H40.7C18.3,0,0,18.3,0,40.7v404.7c0,22.4,18.3,40.7,40.7,40.7h404.7c22.4,0,40.7-18.3,40.7-40.7V40.7
			...
			C24,31.5,31.5,24,40.7,24h404.7c9.2,0,16.7,7.5,16.7,16.7v404.8H462.2z"
                    ...
                    <path
                      fill="#f863a3"
                      d="M193,300.6c-4.7-4.7-12.3-4.7-17,0l-36.1,36.1l-36.1-36.1c-4.7-4.7-12.3-4.7-17,0s-4.7,12.3,0,17l36.1,36.1l-36.1,36.1
			...
			s6.1-1.2,8.5-3.5c4.7-4.7,4.7-12.3,0-17l-36.1-36.1l36.1-36.1C197.7,312.9,197.7,305.3,193,300.6z"
                    ...
                    <path
                      fill="#f863a3"
                      d="M203,131.7h-51v-51c0-6.6-5.4-12-12-12s-12,5.4-12,12v51H77c-6.6,0-12,5.4-12,12s5.4,12,12,12h51v51c0,6.6,5.4,12,12,12
            ...
            >
              ...
              >
                <g transform="translate(-1145.331 -567.731)  ">
                  ...
                  >
                    <path
                      transform="translate(-0.425 -2.604) scale(2.1)"
                      fill="#9c55ba"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="links__item" style="height: 120px">
            ...
            >
              <svg
                ...
                class="text-center items-center align-middle"
              >
              <g transform="translate(-4 3.093) rotate(-20) scale(0.85)">
                <path
                fill="#95ce31"
