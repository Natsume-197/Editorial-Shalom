<template>
  ...
  <div class="waveWrapper waveAnimation -z-10 ">
  ...
  <div class=" pb-6 sm:pb-8 lg:pb-12 mt-32 mb-40">
...
.waveWrapperInner {
    ...
    height: 100%;
    bottom: -1px;
    background-image: linear-gradient(to top, rgb(2 132 199) 20%, rgb(2 132 199) 80%);
}
.bgTop {
    z-index: 15;
    opacity: 0.5;
