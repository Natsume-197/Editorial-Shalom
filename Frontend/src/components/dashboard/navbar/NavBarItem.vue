...
const itemLabel = computed(() =>
  ...
  props.item.isCurrentUser ? "¡Hola, "+useMainStore().userName+"!" : props.item.label
);
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{
        'bg-gray-100 dark:bg-blue-darkBg lg:bg-transparent lg:dark:bg-transparent p-3 lg:p-0':
          item.menu,
      }"
    >
    ...
    <div
      v-if="item.menu"
      class="text-sm border-b border-gray-100 lg:border lg:bg-white lg:absolute lg:top-full lg:left-0 lg:min-w-full lg:z-20 lg:rounded-lg lg:shadow-lg lg:dark:bg-blue-darkBg dark:border-slate-700"
